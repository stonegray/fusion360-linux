# install-scripts/25-install-to-location.sh — Copy runtime scripts to XDG data dir
...
cp -r "$SCRIPT_DIR/runtime-scripts" "$F360_DATA_DIR/"
cp "$SCRIPT_DIR/launch-fusion.sh" "$F360_DATA_DIR/"
