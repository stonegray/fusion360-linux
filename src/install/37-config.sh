...
BROWSER=$F360_DATA_DIR/runtime-scripts/fusion-browser.sh
BROWSER_LISTENER=$F360_DATA_DIR/runtime-scripts/fusion-browser-listener.sh
CALLBACK_HANDLER=$F360_DATA_DIR/runtime-scripts/fusion-callback-handler.sh
CHROME=${BROWSER:-/usr/bin/firefox}
FUSION_OVERLAY_KILLER=$F360_DATA_DIR/runtime-scripts/fusion-gray-overlay-event-killer.sh
FUSION_WINE_RESTART_SCRIPT=$F360_DATA_DIR/runtime-scripts/kill-wine-proton-fusion-nuclear.sh
...
FUSION_STAGING_WRITECOPY=1
FUSION_HEAP_DELAY_FREE=1
